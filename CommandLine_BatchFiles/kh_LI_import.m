...
for i = 3 :  size(List)
    if ( 0 == strcmp( List(i,1).name, '.') && 0 == strcmp( List(i,1).name, '..') )
        ...
        [Inputimage,Inclusivemask,Exclusivemask,Threshold,LI,Method,VCVV,VarianceWeighting,Clustering,Sourcepath,Voxelsright,Voxelsleft,Clustersright,Clustersleft] = importfile(strcat(Path.Statistics.VG, filesep, 'LI_Wernicke_p_001.txt'),2, 2);
